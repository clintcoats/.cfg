...
myKeys =
    ...
    [("S-C-a", windows copyToAll)   -- copy window to all workspaces
     ...
     , ("M-p", spawn "dmenu_run -p 'Yes Clint ?'") -- dmenu
...
main = do
    xmproc0 <- spawnPipe "xmobar -x 0 /home/clint/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/clint/.config/xmobar/xmobarrc1"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/clint/.config/xmobar/xmobarrc2"
